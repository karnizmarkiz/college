...
<head>
    ...
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="/admin-assets/fontawesome.min.css">
    <!-- Theme style -->
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('admin')}}" class="nav-link">Группы</a>
            </li>
            <?if (Auth::user()->role === '4'):?>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/admin/new-users" class="nav-link">Новые пользователи</a>
            </li>
            <?endif;?>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/" class="brand-link">
            <span class="brand-text font-weight-light">ВПолК</span>
        </a>
